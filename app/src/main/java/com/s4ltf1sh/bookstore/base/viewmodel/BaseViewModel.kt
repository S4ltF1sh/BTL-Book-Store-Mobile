package com.s4ltf1sh.bookstore.base.viewmodel

import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.s4ltf1sh.bookstore.base.network.BaseNetworkException
import com.s4ltf1sh.bookstore.base.network.NetworkErrorException
import com.s4ltf1sh.bookstore.common.Event
    ...
    protected open fun parseErrorCallApi(e: Throwable) {
        when (e) {
            ...
            is NetworkErrorException -> {
                ...
                unknownException.mainMessage = e.message ?: Strings.SOMETHING_WENT_WRONG
