package com.s4ltf1sh.bookstore.base.activities
...
import com.s4ltf1sh.bookstore.base.dialogs.ConfirmDialog
import com.s4ltf1sh.bookstore.base.dialogs.ErrorDialog
import com.s4ltf1sh.bookstore.base.dialogs.NotifyDialog
import com.s4ltf1sh.bookstore.common.extensions.ActivityInflate
...
abstract class BaseActivity<VB : ViewBinding>(private val inflate: ActivityInflate<VB>) : AppCompatActivity() {
    ...
    private fun initActivity() {
        //init view binding:
        _viewBinding = inflate.invoke(layoutInflater)
    }
